...
model_url="https://paddle-imagenet-models-name.bj.bcebos.com/dygraph/inference/MobileNetV3_small_x0_35_ssld_infer.tar"
model_zip_name="MobileNetV3_small_x0_35_ssld_infer.tar"
model_input_node_name="x"
model_output_node_name="output"
tvm_input_model_path="MobileNetV3_small_x0_35_ssld_infer/inference/inference.pdmodel"
