...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add(float* p0, float* p1, float* T_add, uint8_t* global_const_workspace_16_var, uint8_t* global_workspace_17_var) {
  ...
  void* data_vec_let = (&(global_workspace_17_var[8192]));
  for (int32_t h = 0; h < 8; ++h) {
    for (int32_t w = 0; w < 8; ++w) {
      for (int32_t ci = 0; ci < 8; ++ci) {
        for (int32_t vh = 0; vh < 2; ++vh) {
          for (int32_t vw = 0; vw < 2; ++vw) {
            ((float*)data_vec_let)[(((((h * 256) + (w * 32)) + (ci * 4)) + (vh * 2)) + vw)] = p0[(((((ci * 256) + (h * 32)) + (vh * 16)) + (w * 2)) + vw)];
          }
        }
      }
    }
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 2; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 8; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 8; ++ax3_outer) {
        void* conv_let = (&(global_workspace_17_var[16640]));
        ...
        for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
          for (int32_t vc = 0; vc < 4; ++vc) {
            for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
              ...
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 256) + (ax3_outer * 32)) + cse_var_2) + vw_1)] * p1[(((ax1_outer * 32) + cse_var_2) + vc)]));
            }
            for (int32_t vw_2 = 0; vw_2 < 2; ++vw_2) {
              int32_t cse_var_4 = (ci_1 * 4);
              int32_t cse_var_3 = (((vw_2 * 4) + vc) + 8);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 256) + (ax3_outer * 32)) + cse_var_4) + vw_2) + 2)] * p1[(((ax1_outer * 32) + cse_var_4) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            T_add[(((((ax1_outer * 1024) + (ax1_inner * 256)) + (ax2_outer * 32)) + (ax3_outer * 2)) + ax3_inner)] = (((float*)conv_let)[((ax3_inner * 4) + ax1_inner)] + ((float*)fused_nn_conv2d_constant_5_let)[((ax1_outer * 4) + ax1_inner)]);
          }
        }
        for (int32_t ax3_inner_1 = 0; ax3_inner_1 < 2; ++ax3_inner_1) {
          for (int32_t ax1_inner_1 = 0; ax1_inner_1 < 4; ++ax1_inner_1) {
            T_add[((((((ax1_outer * 1024) + (ax1_inner_1 * 256)) + (ax2_outer * 32)) + (ax3_outer * 2)) + ax3_inner_1) + 16)] = (((float*)conv_let)[(((ax3_inner_1 * 4) + ax1_inner_1) + 8)] + ((float*)fused_nn_conv2d_constant_5_let)[((ax1_outer * 4) + ax1_inner_1)]);
          }
        }
      }
    }
  ...
  for (int32_t h = 0; h < 4; ++h) {
    for (int32_t w = 0; w < 4; ++w) {
      for (int32_t ci = 0; ci < 24; ++ci) {
        for (int32_t vh = 0; vh < 2; ++vh) {
          for (int32_t vw = 0; vw < 2; ++vw) {
            ((float*)data_vec_let)[(((((h * 384) + (w * 96)) + (ci * 4)) + (vh * 2)) + vw)] = p0[(((((ci * 64) + (h * 16)) + (vh * 8)) + (w * 2)) + vw)];
          }
        }
      }
    }
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 2; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 4; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 4; ++ax3_outer) {
        void* conv_let = (&(global_workspace_23_var[6144]));
        for (int32_t vc_init = 0; vc_init < 4; ++vc_init) {
          for (int32_t vw_init = 0; vw_init < 2; ++vw_init) {
            ((float*)conv_let)[((vw_init * 4) + vc_init)] = 0.000000e+00f;
          }
        ...
        for (int32_t ci_1 = 0; ci_1 < 24; ++ci_1) {
          for (int32_t vc = 0; vc < 4; ++vc) {
            for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
              int32_t cse_var_2 = (ci_1 * 4);
              int32_t cse_var_1 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 384) + (ax3_outer * 96)) + cse_var_2) + vw_1)] * ((float*)fused_constant_8_let)[(((ax1_outer * 96) + cse_var_2) + vc)]));
            }
            for (int32_t vw_2 = 0; vw_2 < 2; ++vw_2) {
              int32_t cse_var_4 = (ci_1 * 4);
              int32_t cse_var_3 = (((vw_2 * 4) + vc) + 8);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 384) + (ax3_outer * 96)) + cse_var_4) + vw_2) + 2)] * ((float*)fused_constant_8_let)[(((ax1_outer * 96) + cse_var_4) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            T_add[(((((ax1_outer * 256) + (ax1_inner * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner)] = (((float*)conv_let)[((ax3_inner * 4) + ax1_inner)] + ((float*)fused_nn_conv2d_constant_8_let)[((ax1_outer * 4) + ax1_inner)]);
          }
        }
        for (int32_t ax3_inner_1 = 0; ax3_inner_1 < 2; ++ax3_inner_1) {
          for (int32_t ax1_inner_1 = 0; ax1_inner_1 < 4; ++ax1_inner_1) {
            T_add[((((((ax1_outer * 256) + (ax1_inner_1 * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner_1) + 8)] = (((float*)conv_let)[(((ax3_inner_1 * 4) + ax1_inner_1) + 8)] + ((float*)fused_nn_conv2d_constant_8_let)[((ax1_outer * 4) + ax1_inner_1)]);
          }
        }
      }
    }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_add(float* p0, float* p1, float* T_add, uint8_t* global_const_workspace_28_var, uint8_t* global_workspace_29_var) {
  ...
  for (int32_t h = 0; h < 4; ++h) {
    for (int32_t w = 0; w < 4; ++w) {
      for (int32_t ci = 0; ci < 32; ++ci) {
        for (int32_t vh = 0; vh < 2; ++vh) {
          for (int32_t vw = 0; vw < 2; ++vw) {
            ((float*)data_vec_let)[(((((h * 512) + (w * 128)) + (ci * 4)) + (vh * 2)) + vw)] = p0[(((((ci * 64) + (h * 16)) + (vh * 8)) + (w * 2)) + vw)];
          }
        }
      }
    }
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 2; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 4; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 4; ++ax3_outer) {
        void* conv_let = (&(global_workspace_29_var[10240]));
        for (int32_t vc_init = 0; vc_init < 4; ++vc_init) {
          for (int32_t vw_init = 0; vw_init < 2; ++vw_init) {
            ((float*)conv_let)[((vw_init * 4) + vc_init)] = 0.000000e+00f;
          }
        ...
        for (int32_t ci_1 = 0; ci_1 < 32; ++ci_1) {
          for (int32_t vc = 0; vc < 4; ++vc) {
            for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
              int32_t cse_var_2 = (ci_1 * 4);
              int32_t cse_var_1 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 512) + (ax3_outer * 128)) + cse_var_2) + vw_1)] * ((float*)fused_constant_11_let)[(((ax1_outer * 128) + cse_var_2) + vc)]));
            }
            for (int32_t vw_2 = 0; vw_2 < 2; ++vw_2) {
              int32_t cse_var_4 = (ci_1 * 4);
              int32_t cse_var_3 = (((vw_2 * 4) + vc) + 8);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 512) + (ax3_outer * 128)) + cse_var_4) + vw_2) + 2)] * ((float*)fused_constant_11_let)[(((ax1_outer * 128) + cse_var_4) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            int32_t cse_var_5 = (((((ax1_outer * 256) + (ax1_inner * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner);
            T_add[cse_var_5] = (p1[cse_var_5] + (((float*)conv_let)[((ax3_inner * 4) + ax1_inner)] + ((float*)fused_nn_conv2d_constant_11_let)[((ax1_outer * 4) + ax1_inner)]));
          }
        }
        for (int32_t ax3_inner_1 = 0; ax3_inner_1 < 2; ++ax3_inner_1) {
          for (int32_t ax1_inner_1 = 0; ax1_inner_1 < 4; ++ax1_inner_1) {
            int32_t cse_var_6 = ((((((ax1_outer * 256) + (ax1_inner_1 * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner_1) + 8);
            T_add[cse_var_6] = (p1[cse_var_6] + (((float*)conv_let)[(((ax3_inner_1 * 4) + ax1_inner_1) + 8)] + ((float*)fused_nn_conv2d_constant_11_let)[((ax1_outer * 4) + ax1_inner_1)]));
          }
        }
      }
    }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_add_clip_multiply_divide(float* p0, float* T_divide, uint8_t* global_const_workspace_2_var, uint8_t* global_workspace_3_var) {
      ...
      for (int32_t ci = 0; ci < 3; ++ci) {
        for (int32_t vh = 0; vh < 3; ++vh) {
          for (int32_t vw = 0; vw < 9; ++vw) {
            int32_t cse_var_1 = (w * 8);
            ((float*)data_vec_let)[(((((h * 648) + (w * 81)) + (ci * 27)) + (vh * 9)) + vw)] = (((1 <= ((h * 2) + vh)) && (1 <= (cse_var_1 + vw))) ? p0[((((((ci * 4096) + (h * 128)) + (vh * 64)) + cse_var_1) + vw) - 65)] : 0.000000e+00f);
          }
        }
      }
    }
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 2; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 32; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 8; ++ax3_outer) {
        void* conv_let = (&(global_workspace_3_var[115712]));
        ...
        for (int32_t ci_1 = 0; ci_1 < 3; ++ci_1) {
          for (int32_t vw_1 = 0; vw_1 < 4; ++vw_1) {
            for (int32_t vc = 0; vc < 4; ++vc) {
              int32_t cse_var_2 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_2] = (((float*)conv_let)[cse_var_2] + (((float*)data_vec_let)[((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_1 * 2))] * ((float*)fused_constant_let)[(((ax1_outer * 108) + (ci_1 * 36)) + vc)]));
            }
          }
          for (int32_t vw_2 = 0; vw_2 < 4; ++vw_2) {
            for (int32_t vc_1 = 0; vc_1 < 4; ++vc_1) {
              int32_t cse_var_3 = ((vw_2 * 4) + vc_1);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_2 * 2)) + 1)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_1) + 4)]));
            }
          }
          for (int32_t vw_3 = 0; vw_3 < 4; ++vw_3) {
            for (int32_t vc_2 = 0; vc_2 < 4; ++vc_2) {
              int32_t cse_var_4 = ((vw_3 * 4) + vc_2);
              ((float*)conv_let)[cse_var_4] = (((float*)conv_let)[cse_var_4] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_3 * 2)) + 2)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_2) + 8)]));
            }
          }
          for (int32_t vw_4 = 0; vw_4 < 4; ++vw_4) {
            for (int32_t vc_3 = 0; vc_3 < 4; ++vc_3) {
              int32_t cse_var_5 = ((vw_4 * 4) + vc_3);
              ((float*)conv_let)[cse_var_5] = (((float*)conv_let)[cse_var_5] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_4 * 2)) + 9)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_3) + 12)]));
            }
          }
          for (int32_t vw_5 = 0; vw_5 < 4; ++vw_5) {
            for (int32_t vc_4 = 0; vc_4 < 4; ++vc_4) {
              int32_t cse_var_6 = ((vw_5 * 4) + vc_4);
              ((float*)conv_let)[cse_var_6] = (((float*)conv_let)[cse_var_6] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_5 * 2)) + 10)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_4) + 16)]));
            }
          }
          for (int32_t vw_6 = 0; vw_6 < 4; ++vw_6) {
            for (int32_t vc_5 = 0; vc_5 < 4; ++vc_5) {
              int32_t cse_var_7 = ((vw_6 * 4) + vc_5);
              ((float*)conv_let)[cse_var_7] = (((float*)conv_let)[cse_var_7] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_6 * 2)) + 11)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_5) + 20)]));
            }
          }
          for (int32_t vw_7 = 0; vw_7 < 4; ++vw_7) {
            for (int32_t vc_6 = 0; vc_6 < 4; ++vc_6) {
              int32_t cse_var_8 = ((vw_7 * 4) + vc_6);
              ((float*)conv_let)[cse_var_8] = (((float*)conv_let)[cse_var_8] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_7 * 2)) + 18)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_6) + 24)]));
            }
          }
          for (int32_t vw_8 = 0; vw_8 < 4; ++vw_8) {
            for (int32_t vc_7 = 0; vc_7 < 4; ++vc_7) {
              int32_t cse_var_9 = ((vw_8 * 4) + vc_7);
              ((float*)conv_let)[cse_var_9] = (((float*)conv_let)[cse_var_9] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_8 * 2)) + 19)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_7) + 28)]));
            }
          }
          for (int32_t vw_9 = 0; vw_9 < 4; ++vw_9) {
            for (int32_t vc_8 = 0; vc_8 < 4; ++vc_8) {
              int32_t cse_var_10 = ((vw_9 * 4) + vc_8);
              ((float*)conv_let)[cse_var_10] = (((float*)conv_let)[cse_var_10] + (((float*)data_vec_let)[(((((ax2_outer * 648) + (ax3_outer * 81)) + (ci_1 * 27)) + (vw_9 * 2)) + 20)] * ((float*)fused_constant_let)[((((ax1_outer * 108) + (ci_1 * 36)) + vc_8) + 32)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 4; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            ...
            T_divide[(((((ax1_outer * 4096) + (ax1_inner * 1024)) + (ax2_outer * 32)) + (ax3_outer * 4)) + ax3_inner)] = (((((float*)conv_let)[cse_var_12] + ((float*)fused_nn_conv2d_constant_let)[cse_var_11]) * ((__2) > (0.000000e+00f) ? (__2) : (0.000000e+00f))) * 1.666667e-01f);
          }
        }
      }
    }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_add_clip_multiply_divide_1(float* p0, float* T_divide, uint8_t* global_const_workspace_30_var, uint8_t* global_workspace_31_var) {
  ...
  void* data_vec_let = (&(global_workspace_31_var[10240]));
  for (int32_t h = 0; h < 4; ++h) {
    for (int32_t w = 0; w < 4; ++w) {
      for (int32_t ci = 0; ci < 8; ++ci) {
        for (int32_t vh = 0; vh < 2; ++vh) {
          for (int32_t vw = 0; vw < 2; ++vw) {
            ((float*)data_vec_let)[(((((h * 128) + (w * 32)) + (ci * 4)) + (vh * 2)) + vw)] = p0[(((((ci * 64) + (h * 16)) + (vh * 8)) + (w * 2)) + vw)];
          }
        }
      }
    }
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 8; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 4; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 4; ++ax3_outer) {
        void* conv_let = (&(global_workspace_31_var[8192]));
        for (int32_t vc_init = 0; vc_init < 4; ++vc_init) {
          for (int32_t vw_init = 0; vw_init < 2; ++vw_init) {
            ((float*)conv_let)[((vw_init * 4) + vc_init)] = 0.000000e+00f;
          }
        ...
        for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
          for (int32_t vc = 0; vc < 4; ++vc) {
            for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
              int32_t cse_var_2 = (ci_1 * 4);
              int32_t cse_var_1 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 128) + (ax3_outer * 32)) + cse_var_2) + vw_1)] * ((float*)fused_constant_12_let)[(((ax1_outer * 32) + cse_var_2) + vc)]));
            }
            for (int32_t vw_2 = 0; vw_2 < 2; ++vw_2) {
              int32_t cse_var_4 = (ci_1 * 4);
              int32_t cse_var_3 = (((vw_2 * 4) + vc) + 8);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 128) + (ax3_outer * 32)) + cse_var_4) + vw_2) + 2)] * ((float*)fused_constant_12_let)[(((ax1_outer * 32) + cse_var_4) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            ...
            float __1 = (((float*)conv_let)[cse_var_6] + ((float*)fused_nn_conv2d_constant_12_let)[cse_var_5]) + 3.000000e+00f;
            float __2 = (__1) < (6.000000e+00f) ? (__1) : (6.000000e+00f);
            T_divide[(((((ax1_outer * 256) + (ax1_inner * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner)] = (((((float*)conv_let)[cse_var_6] + ((float*)fused_nn_conv2d_constant_12_let)[cse_var_5]) * ((__2) > (0.000000e+00f) ? (__2) : (0.000000e+00f))) * 1.666667e-01f);
          }
        }
        for (int32_t ax3_inner_1 = 0; ax3_inner_1 < 2; ++ax3_inner_1) {
          for (int32_t ax1_inner_1 = 0; ax1_inner_1 < 4; ++ax1_inner_1) {
            ...
            float __3 = (((float*)conv_let)[cse_var_7] + ((float*)fused_nn_conv2d_constant_12_let)[cse_var_8]) + 3.000000e+00f;
            float __4 = (__3) < (6.000000e+00f) ? (__3) : (6.000000e+00f);
            T_divide[((((((ax1_outer * 256) + (ax1_inner_1 * 64)) + (ax2_outer * 16)) + (ax3_outer * 2)) + ax3_inner_1) + 8)] = (((((float*)conv_let)[cse_var_7] + ((float*)fused_nn_conv2d_constant_12_let)[cse_var_8]) * ((__4) > (0.000000e+00f) ? (__4) : (0.000000e+00f))) * 1.666667e-01f);
          }
        }
      }
    }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_add_clip_multiply_divide_2(float* p0, float* T_divide, uint8_t* global_const_workspace_32_var, uint8_t* global_workspace_33_var) {
  ...
  void* fused_constant_13_global_global_let = (&(global_workspace_33_var[8192]));
  ...
  void* DepthwiseConv2d_global_let = (&(global_workspace_33_var[11392]));
  for (int32_t c_outer_c = 0; c_outer_c < 8; ++c_outer_c) {
    void* PaddedInput_global_global_let = (&(global_workspace_33_var[13440]));
    for (int32_t ax2_c_1 = 0; ax2_c_1 < 11; ++ax2_c_1) {
      for (int32_t ax3_c_1 = 0; ax3_c_1 < 11; ++ax3_c_1) {
        for (int32_t ax1_inner_c = 0; ax1_inner_c < 4; ++ax1_inner_c) {
          ((float*)PaddedInput_global_global_let)[(((ax2_c_1 * 44) + (ax3_c_1 * 4)) + ax1_inner_c)] = (((((2 <= ax2_c_1) && (ax2_c_1 < 10)) && (2 <= ax3_c_1)) && (ax3_c_1 < 10)) ? p0[(((((c_outer_c * 256) + (ax1_inner_c * 64)) + (ax2_c_1 * 8)) + ax3_c_1) - 18)] : 0.000000e+00f);
        }
      }
    }
    for (int32_t j_c_outer = 0; j_c_outer < 2; ++j_c_outer) {
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu(float* p0, float* T_relu, uint8_t* global_const_workspace_4_var, uint8_t* global_workspace_5_var) {
  ...
  void* data_vec_let = (&(global_workspace_5_var[32768]));
  for (int32_t h = 0; h < 32; ++h) {
    for (int32_t w = 0; w < 8; ++w) {
      for (int32_t ci = 0; ci < 8; ++ci) {
        for (int32_t vw = 0; vw < 4; ++vw) {
          ((float*)data_vec_let)[((((h * 256) + (w * 32)) + (ci * 4)) + vw)] = p0[((((ci * 1024) + (h * 32)) + (w * 4)) + vw)];
        }
      }
    }
  }
  for (int32_t ax1_outer = 0; ax1_outer < 2; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 32; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 8; ++ax3_outer) {
        void* conv_let = (&(global_workspace_5_var[65536]));
        for (int32_t vw_init = 0; vw_init < 4; ++vw_init) {
          for (int32_t vc_init = 0; vc_init < 4; ++vc_init) {
            ((float*)conv_let)[((vw_init * 4) + vc_init)] = 0.000000e+00f;
          }
        ...
        for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
          for (int32_t vw_1 = 0; vw_1 < 4; ++vw_1) {
            for (int32_t vc = 0; vc < 4; ++vc) {
              int32_t cse_var_2 = (ci_1 * 4);
              int32_t cse_var_1 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 256) + (ax3_outer * 32)) + cse_var_2) + vw_1)] * ((float*)fused_constant_1_let)[(((ax1_outer * 32) + cse_var_2) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 4; ++ax3_inner) {
          for (int32_t ax1_inner = 0; ax1_inner < 4; ++ax1_inner) {
            ...
            T_relu[(((((ax1_outer * 4096) + (ax1_inner * 1024)) + (ax2_outer * 32)) + (ax3_outer * 4)) + ax3_inner)] = ((__1) > (0.000000e+00f) ? (__1) : (0.000000e+00f));
          }
        }
      }
    }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_1(float* p0, float* T_relu, uint8_t* global_const_workspace_6_var, uint8_t* global_workspace_7_var) {
  ...
  void* fused_constant_2_global_global_let = (&(global_workspace_7_var[45712]));
  ...
  void* DepthwiseConv2d_global_let = (&(global_workspace_7_var[32768]));
  for (int32_t c_outer_c = 0; c_outer_c < 2; ++c_outer_c) {
    for (int32_t i_c_outer = 0; i_c_outer < 4; ++i_c_outer) {
      void* PaddedInput_global_global_let = (&(global_workspace_7_var[40960]));
          ...
          for (int32_t dj = 0; dj < 3; ++dj) {
            for (int32_t j_c_inner = 0; j_c_inner < 2; ++j_c_inner) {
              for (int32_t c_inner_c = 0; c_inner_c < 4; ++c_inner_c) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_2] = (((float*)DepthwiseConv2d_global_let)[cse_var_2] + (((float*)PaddedInput_global_global_let)[(((((di * 132) + (j_c_outer * 16)) + (j_c_inner * 8)) + cse_var_3) + c_inner_c)] * ((float*)fused_constant_2_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_3) + c_inner_c)]));
              }
            }
            for (int32_t j_c_inner_1 = 0; j_c_inner_1 < 2; ++j_c_inner_1) {
              for (int32_t c_inner_c_1 = 0; c_inner_c_1 < 4; ++c_inner_c_1) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_4] = (((float*)DepthwiseConv2d_global_let)[cse_var_4] + (((float*)PaddedInput_global_global_let)[((((((di * 132) + (j_c_outer * 16)) + (j_c_inner_1 * 8)) + cse_var_5) + c_inner_c_1) + 264)] * ((float*)fused_constant_2_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_5) + c_inner_c_1)]));
              }
            }
            for (int32_t j_c_inner_2 = 0; j_c_inner_2 < 2; ++j_c_inner_2) {
              for (int32_t c_inner_c_2 = 0; c_inner_c_2 < 4; ++c_inner_c_2) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_6] = (((float*)DepthwiseConv2d_global_let)[cse_var_6] + (((float*)PaddedInput_global_global_let)[((((((di * 132) + (j_c_outer * 16)) + (j_c_inner_2 * 8)) + cse_var_7) + c_inner_c_2) + 528)] * ((float*)fused_constant_2_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_7) + c_inner_c_2)]));
              }
            }
            for (int32_t j_c_inner_3 = 0; j_c_inner_3 < 2; ++j_c_inner_3) {
              for (int32_t c_inner_c_3 = 0; c_inner_c_3 < 4; ++c_inner_c_3) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_8] = (((float*)DepthwiseConv2d_global_let)[cse_var_8] + (((float*)PaddedInput_global_global_let)[((((((di * 132) + (j_c_outer * 16)) + (j_c_inner_3 * 8)) + cse_var_9) + c_inner_c_3) + 792)] * ((float*)fused_constant_2_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_9) + c_inner_c_3)]));
              }
            }
          }
        }
  ...
  for (int32_t ax1 = 0; ax1 < 8; ++ax1) {
    for (int32_t ax2 = 0; ax2 < 16; ++ax2) {
      for (int32_t ax3 = 0; ax3 < 16; ++ax3) {
        float __1 = ((float*)DepthwiseConv2d_global_let)[(((((ax1 >> 2) * 1024) + (ax2 * 64)) + (ax3 * 4)) + (ax1 & 3))] + ((float*)fused_nn_conv2d_constant_2_let)[ax1];
        T_relu[(((ax1 * 256) + (ax2 * 16)) + ax3)] = ((__1) > (0.000000e+00f) ? (__1) : (0.000000e+00f));
      }
    }
  }
  return 0;
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_2(float* p0, float* T_relu, uint8_t* global_const_workspace_10_var, uint8_t* global_workspace_11_var) {
  ...
  void* data_vec_let = (&(global_workspace_11_var[8224]));
  for (int32_t ci = 0; ci < 8; ++ci) {
    ((float*)data_vec_let)[ci] = p0[ci];
  }
  void* conv_let = (&(global_workspace_11_var[8208]));
  for (int32_t vc_init = 0; vc_init < 2; ++vc_init) {
    ((float*)conv_let)[vc_init] = 0.000000e+00f;
  }
  for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_3(float* p0, float* T_relu, uint8_t* global_const_workspace_18_var, uint8_t* global_workspace_19_var) {
  ...
  void* data_vec_let = (&(global_workspace_19_var[24576]));
  for (int32_t h = 0; h < 16; ++h) {
    for (int32_t w = 0; w < 8; ++w) {
      for (int32_t ci = 0; ci < 8; ++ci) {
        for (int32_t vw = 0; vw < 2; ++vw) {
          ((float*)data_vec_let)[((((h * 128) + (w * 16)) + (ci * 2)) + vw)] = p0[((((ci * 256) + (h * 16)) + (w * 2)) + vw)];
        }
      }
    }
  }
  for (int32_t ax1_outer = 0; ax1_outer < 3; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 16; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 8; ++ax3_outer) {
        void* conv_let = (&(global_workspace_19_var[32768]));
        for (int32_t vw_init = 0; vw_init < 2; ++vw_init) {
          for (int32_t vc_init = 0; vc_init < 8; ++vc_init) {
        ...
        for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
          for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
            for (int32_t vc = 0; vc < 8; ++vc) {
              ...
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 128) + (ax3_outer * 16)) + (ci_1 * 2)) + vw_1)] * ((float*)fused_constant_6_let)[(((ax1_outer * 64) + (ci_1 * 8)) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_4(float* p0, float* T_relu, uint8_t* global_const_workspace_20_var, uint8_t* global_workspace_21_var) {
  ...
  void* fused_constant_7_global_global_let = (&(global_workspace_21_var[33168]));
  ...
  void* DepthwiseConv2d_global_let = (&(global_workspace_21_var[24576]));
  for (int32_t c_outer_c = 0; c_outer_c < 6; ++c_outer_c) {
    for (int32_t i_c_outer = 0; i_c_outer < 2; ++i_c_outer) {
      void* PaddedInput_global_global_let = (&(global_workspace_21_var[30720]));
      for (int32_t ax2_c_1 = 0; ax2_c_1 < 9; ++ax2_c_1) {
          ...
          for (int32_t dj = 0; dj < 3; ++dj) {
            for (int32_t j_c_inner = 0; j_c_inner < 2; ++j_c_inner) {
              for (int32_t c_inner_c = 0; c_inner_c < 4; ++c_inner_c) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_2] = (((float*)DepthwiseConv2d_global_let)[cse_var_2] + (((float*)PaddedInput_global_global_let)[(((((di * 68) + (j_c_outer * 16)) + (j_c_inner * 8)) + cse_var_3) + c_inner_c)] * ((float*)fused_constant_7_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_3) + c_inner_c)]));
              }
            }
            for (int32_t j_c_inner_1 = 0; j_c_inner_1 < 2; ++j_c_inner_1) {
              for (int32_t c_inner_c_1 = 0; c_inner_c_1 < 4; ++c_inner_c_1) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_4] = (((float*)DepthwiseConv2d_global_let)[cse_var_4] + (((float*)PaddedInput_global_global_let)[((((((di * 68) + (j_c_outer * 16)) + (j_c_inner_1 * 8)) + cse_var_5) + c_inner_c_1) + 136)] * ((float*)fused_constant_7_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_5) + c_inner_c_1)]));
              }
            }
            for (int32_t j_c_inner_2 = 0; j_c_inner_2 < 2; ++j_c_inner_2) {
              for (int32_t c_inner_c_2 = 0; c_inner_c_2 < 4; ++c_inner_c_2) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_6] = (((float*)DepthwiseConv2d_global_let)[cse_var_6] + (((float*)PaddedInput_global_global_let)[((((((di * 68) + (j_c_outer * 16)) + (j_c_inner_2 * 8)) + cse_var_7) + c_inner_c_2) + 272)] * ((float*)fused_constant_7_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_7) + c_inner_c_2)]));
              }
            }
            for (int32_t j_c_inner_3 = 0; j_c_inner_3 < 2; ++j_c_inner_3) {
              for (int32_t c_inner_c_3 = 0; c_inner_c_3 < 4; ++c_inner_c_3) {
                ...
                ((float*)DepthwiseConv2d_global_let)[cse_var_8] = (((float*)DepthwiseConv2d_global_let)[cse_var_8] + (((float*)PaddedInput_global_global_let)[((((((di * 68) + (j_c_outer * 16)) + (j_c_inner_3 * 8)) + cse_var_9) + c_inner_c_3) + 408)] * ((float*)fused_constant_7_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_9) + c_inner_c_3)]));
              }
            }
          }
        }
  ...
  for (int32_t ax1 = 0; ax1 < 24; ++ax1) {
    for (int32_t ax2 = 0; ax2 < 8; ++ax2) {
      for (int32_t ax3 = 0; ax3 < 8; ++ax3) {
        float __1 = ((float*)DepthwiseConv2d_global_let)[(((((ax1 >> 2) * 256) + (ax2 * 32)) + (ax3 * 4)) + (ax1 & 3))] + ((float*)fused_nn_conv2d_constant_7_let)[ax1];
        T_relu[(((ax1 * 64) + (ax2 * 8)) + ax3)] = ((__1) > (0.000000e+00f) ? (__1) : (0.000000e+00f));
      }
    }
  }
  return 0;
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_5(float* p0, float* T_relu, uint8_t* global_const_workspace_24_var, uint8_t* global_workspace_25_var) {
  ...
  void* data_vec_let = (&(global_workspace_25_var[8192]));
  for (int32_t h = 0; h < 4; ++h) {
    for (int32_t w = 0; w < 4; ++w) {
      for (int32_t ci = 0; ci < 8; ++ci) {
        for (int32_t vh = 0; vh < 2; ++vh) {
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 8; ++ax1_outer) {
    for (int32_t ax2_outer = 0; ax2_outer < 4; ++ax2_outer) {
      for (int32_t ax3_outer = 0; ax3_outer < 4; ++ax3_outer) {
        void* conv_let = (&(global_workspace_25_var[10240]));
        for (int32_t vc_init = 0; vc_init < 4; ++vc_init) {
          for (int32_t vw_init = 0; vw_init < 2; ++vw_init) {
            ((float*)conv_let)[((vw_init * 4) + vc_init)] = 0.000000e+00f;
          }
        ...
        for (int32_t ci_1 = 0; ci_1 < 8; ++ci_1) {
          for (int32_t vc = 0; vc < 4; ++vc) {
            for (int32_t vw_1 = 0; vw_1 < 2; ++vw_1) {
              int32_t cse_var_2 = (ci_1 * 4);
              int32_t cse_var_1 = ((vw_1 * 4) + vc);
              ((float*)conv_let)[cse_var_1] = (((float*)conv_let)[cse_var_1] + (((float*)data_vec_let)[((((ax2_outer * 128) + (ax3_outer * 32)) + cse_var_2) + vw_1)] * ((float*)fused_constant_9_let)[(((ax1_outer * 32) + cse_var_2) + vc)]));
            }
            for (int32_t vw_2 = 0; vw_2 < 2; ++vw_2) {
              int32_t cse_var_4 = (ci_1 * 4);
              int32_t cse_var_3 = (((vw_2 * 4) + vc) + 8);
              ((float*)conv_let)[cse_var_3] = (((float*)conv_let)[cse_var_3] + (((float*)data_vec_let)[(((((ax2_outer * 128) + (ax3_outer * 32)) + cse_var_4) + vw_2) + 2)] * ((float*)fused_constant_9_let)[(((ax1_outer * 32) + cse_var_4) + vc)]));
            }
          }
        }
        for (int32_t ax3_inner = 0; ax3_inner < 2; ++ax3_inner) {
        ...
        for (int32_t ax3_inner_1 = 0; ax3_inner_1 < 2; ++ax3_inner_1) {
          for (int32_t ax1_inner_1 = 0; ax1_inner_1 < 4; ++ax1_inner_1) {
            float __2 = ((float*)conv_let)[(((ax3_inner_1 * 4) + ax1_inner_1) + 8)] + ((float*)fused_nn_conv2d_constant_9_let)[((ax1_outer * 4) + ax1_inner_1)];
...
TVM_DLL int32_t tvmgen_cls_fused_nn_conv2d_add_nn_relu_6(float* p0, float* T_relu, uint8_t* global_const_workspace_26_var, uint8_t* global_workspace_27_var) {
  ...
  void* fused_constant_10_global_global_let = (&(global_workspace_27_var[16384]));
  for (int32_t ax0_outer_c = 0; ax0_outer_c < 8; ++ax0_outer_c) {
    for (int32_t ax2_c = 0; ax2_c < 3; ++ax2_c) {
      for (int32_t ax3_c = 0; ax3_c < 3; ++ax3_c) {
        for (int32_t ax0_inner_c = 0; ax0_inner_c < 4; ++ax0_inner_c) {
  ...
  void* DepthwiseConv2d_global_let = (&(global_workspace_27_var[8192]));
  for (int32_t c_outer_c = 0; c_outer_c < 8; ++c_outer_c) {
    for (int32_t i_c_outer = 0; i_c_outer < 2; ++i_c_outer) {
      void* PaddedInput_global_global_let = (&(global_workspace_27_var[17536]));
      for (int32_t ax2_c_1 = 0; ax2_c_1 < 6; ++ax2_c_1) {
      ...
      for (int32_t j_c_outer = 0; j_c_outer < 2; ++j_c_outer) {
        for (int32_t c_inner_c_init = 0; c_inner_c_init < 4; ++c_inner_c_init) {
          ((float*)DepthwiseConv2d_global_let)[((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_1 = 0; c_inner_c_init_1 < 4; ++c_inner_c_init_1) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_1) + 4)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_2 = 0; c_inner_c_init_2 < 4; ++c_inner_c_init_2) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_2) + 8)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_3 = 0; c_inner_c_init_3 < 4; ++c_inner_c_init_3) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_3) + 12)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_4 = 0; c_inner_c_init_4 < 4; ++c_inner_c_init_4) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_4) + 32)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_5 = 0; c_inner_c_init_5 < 4; ++c_inner_c_init_5) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_5) + 36)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_6 = 0; c_inner_c_init_6 < 4; ++c_inner_c_init_6) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_6) + 40)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_7 = 0; c_inner_c_init_7 < 4; ++c_inner_c_init_7) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_7) + 44)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_8 = 0; c_inner_c_init_8 < 4; ++c_inner_c_init_8) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_8) + 64)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_9 = 0; c_inner_c_init_9 < 4; ++c_inner_c_init_9) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_9) + 68)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_10 = 0; c_inner_c_init_10 < 4; ++c_inner_c_init_10) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_10) + 72)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_11 = 0; c_inner_c_init_11 < 4; ++c_inner_c_init_11) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_11) + 76)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_12 = 0; c_inner_c_init_12 < 4; ++c_inner_c_init_12) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_12) + 96)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_13 = 0; c_inner_c_init_13 < 4; ++c_inner_c_init_13) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_13) + 100)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_14 = 0; c_inner_c_init_14 < 4; ++c_inner_c_init_14) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_14) + 104)] = 0.000000e+00f;
        }
        for (int32_t c_inner_c_init_15 = 0; c_inner_c_init_15 < 4; ++c_inner_c_init_15) {
          ((float*)DepthwiseConv2d_global_let)[(((((c_outer_c * 256) + (i_c_outer * 128)) + (j_c_outer * 16)) + c_inner_c_init_15) + 108)] = 0.000000e+00f;
        }
        for (int32_t di = 0; di < 3; ++di) {
          for (int32_t dj = 0; dj < 3; ++dj) {
            for (int32_t c_inner_c = 0; c_inner_c < 4; ++c_inner_c) {
              ...
              int32_t cse_var_3 = ((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_5) + c_inner_c);
              ((float*)DepthwiseConv2d_global_let)[cse_var_3] = (((float*)DepthwiseConv2d_global_let)[cse_var_3] + (((float*)PaddedInput_global_global_let)[((((di * 40) + cse_var_5) + cse_var_4) + c_inner_c)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_4) + c_inner_c)]));
            }
            for (int32_t c_inner_c_1 = 0; c_inner_c_1 < 4; ++c_inner_c_1) {
              int32_t cse_var_8 = (j_c_outer * 16);
              int32_t cse_var_7 = (dj * 4);
              int32_t cse_var_6 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_8) + c_inner_c_1) + 4);
              ((float*)DepthwiseConv2d_global_let)[cse_var_6] = (((float*)DepthwiseConv2d_global_let)[cse_var_6] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_8) + cse_var_7) + c_inner_c_1) + 4)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_7) + c_inner_c_1)]));
            }
            for (int32_t c_inner_c_2 = 0; c_inner_c_2 < 4; ++c_inner_c_2) {
              int32_t cse_var_11 = (j_c_outer * 16);
              int32_t cse_var_10 = (dj * 4);
              int32_t cse_var_9 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_11) + c_inner_c_2) + 8);
              ((float*)DepthwiseConv2d_global_let)[cse_var_9] = (((float*)DepthwiseConv2d_global_let)[cse_var_9] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_11) + cse_var_10) + c_inner_c_2) + 8)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_10) + c_inner_c_2)]));
            }
            for (int32_t c_inner_c_3 = 0; c_inner_c_3 < 4; ++c_inner_c_3) {
              int32_t cse_var_14 = (j_c_outer * 16);
              int32_t cse_var_13 = (dj * 4);
              int32_t cse_var_12 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_14) + c_inner_c_3) + 12);
              ((float*)DepthwiseConv2d_global_let)[cse_var_12] = (((float*)DepthwiseConv2d_global_let)[cse_var_12] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_14) + cse_var_13) + c_inner_c_3) + 12)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_13) + c_inner_c_3)]));
            }
            for (int32_t c_inner_c_4 = 0; c_inner_c_4 < 4; ++c_inner_c_4) {
              int32_t cse_var_17 = (j_c_outer * 16);
              int32_t cse_var_16 = (dj * 4);
              int32_t cse_var_15 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_17) + c_inner_c_4) + 32);
              ((float*)DepthwiseConv2d_global_let)[cse_var_15] = (((float*)DepthwiseConv2d_global_let)[cse_var_15] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_17) + cse_var_16) + c_inner_c_4) + 40)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_16) + c_inner_c_4)]));
            }
            for (int32_t c_inner_c_5 = 0; c_inner_c_5 < 4; ++c_inner_c_5) {
              int32_t cse_var_20 = (j_c_outer * 16);
              int32_t cse_var_19 = (dj * 4);
              int32_t cse_var_18 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_20) + c_inner_c_5) + 36);
              ((float*)DepthwiseConv2d_global_let)[cse_var_18] = (((float*)DepthwiseConv2d_global_let)[cse_var_18] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_20) + cse_var_19) + c_inner_c_5) + 44)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_19) + c_inner_c_5)]));
            }
            for (int32_t c_inner_c_6 = 0; c_inner_c_6 < 4; ++c_inner_c_6) {
              int32_t cse_var_23 = (j_c_outer * 16);
              int32_t cse_var_22 = (dj * 4);
              int32_t cse_var_21 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_23) + c_inner_c_6) + 40);
              ((float*)DepthwiseConv2d_global_let)[cse_var_21] = (((float*)DepthwiseConv2d_global_let)[cse_var_21] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_23) + cse_var_22) + c_inner_c_6) + 48)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_22) + c_inner_c_6)]));
            }
            for (int32_t c_inner_c_7 = 0; c_inner_c_7 < 4; ++c_inner_c_7) {
              int32_t cse_var_26 = (j_c_outer * 16);
              int32_t cse_var_25 = (dj * 4);
              int32_t cse_var_24 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_26) + c_inner_c_7) + 44);
              ((float*)DepthwiseConv2d_global_let)[cse_var_24] = (((float*)DepthwiseConv2d_global_let)[cse_var_24] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_26) + cse_var_25) + c_inner_c_7) + 52)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_25) + c_inner_c_7)]));
            }
            for (int32_t c_inner_c_8 = 0; c_inner_c_8 < 4; ++c_inner_c_8) {
              int32_t cse_var_29 = (j_c_outer * 16);
              int32_t cse_var_28 = (dj * 4);
              int32_t cse_var_27 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_29) + c_inner_c_8) + 64);
              ((float*)DepthwiseConv2d_global_let)[cse_var_27] = (((float*)DepthwiseConv2d_global_let)[cse_var_27] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_29) + cse_var_28) + c_inner_c_8) + 80)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_28) + c_inner_c_8)]));
            }
            for (int32_t c_inner_c_9 = 0; c_inner_c_9 < 4; ++c_inner_c_9) {
              int32_t cse_var_32 = (j_c_outer * 16);
              int32_t cse_var_31 = (dj * 4);
              int32_t cse_var_30 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_32) + c_inner_c_9) + 68);
              ((float*)DepthwiseConv2d_global_let)[cse_var_30] = (((float*)DepthwiseConv2d_global_let)[cse_var_30] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_32) + cse_var_31) + c_inner_c_9) + 84)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_31) + c_inner_c_9)]));
            }
            for (int32_t c_inner_c_10 = 0; c_inner_c_10 < 4; ++c_inner_c_10) {
              int32_t cse_var_35 = (j_c_outer * 16);
              int32_t cse_var_34 = (dj * 4);
              int32_t cse_var_33 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_35) + c_inner_c_10) + 72);
              ((float*)DepthwiseConv2d_global_let)[cse_var_33] = (((float*)DepthwiseConv2d_global_let)[cse_var_33] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_35) + cse_var_34) + c_inner_c_10) + 88)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_34) + c_inner_c_10)]));
            }
            for (int32_t c_inner_c_11 = 0; c_inner_c_11 < 4; ++c_inner_c_11) {
              int32_t cse_var_38 = (j_c_outer * 16);
              int32_t cse_var_37 = (dj * 4);
              int32_t cse_var_36 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_38) + c_inner_c_11) + 76);
              ((float*)DepthwiseConv2d_global_let)[cse_var_36] = (((float*)DepthwiseConv2d_global_let)[cse_var_36] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_38) + cse_var_37) + c_inner_c_11) + 92)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_37) + c_inner_c_11)]));
            }
            for (int32_t c_inner_c_12 = 0; c_inner_c_12 < 4; ++c_inner_c_12) {
              int32_t cse_var_41 = (j_c_outer * 16);
              int32_t cse_var_40 = (dj * 4);
              int32_t cse_var_39 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_41) + c_inner_c_12) + 96);
              ((float*)DepthwiseConv2d_global_let)[cse_var_39] = (((float*)DepthwiseConv2d_global_let)[cse_var_39] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_41) + cse_var_40) + c_inner_c_12) + 120)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_40) + c_inner_c_12)]));
            }
            for (int32_t c_inner_c_13 = 0; c_inner_c_13 < 4; ++c_inner_c_13) {
              int32_t cse_var_44 = (j_c_outer * 16);
              int32_t cse_var_43 = (dj * 4);
              int32_t cse_var_42 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_44) + c_inner_c_13) + 100);
              ((float*)DepthwiseConv2d_global_let)[cse_var_42] = (((float*)DepthwiseConv2d_global_let)[cse_var_42] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_44) + cse_var_43) + c_inner_c_13) + 124)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_43) + c_inner_c_13)]));
            }
            for (int32_t c_inner_c_14 = 0; c_inner_c_14 < 4; ++c_inner_c_14) {
              int32_t cse_var_47 = (j_c_outer * 16);
              int32_t cse_var_46 = (dj * 4);
              int32_t cse_var_45 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_47) + c_inner_c_14) + 104);
              ((float*)DepthwiseConv2d_global_let)[cse_var_45] = (((float*)DepthwiseConv2d_global_let)[cse_var_45] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_47) + cse_var_46) + c_inner_c_14) + 128)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_46) + c_inner_c_14)]));
            }
            for (int32_t c_inner_c_15 = 0; c_inner_c_15 < 4; ++c_inner_c_15) {
              int32_t cse_var_50 = (j_c_outer * 16);
              int32_t cse_var_49 = (dj * 4);
              int32_t cse_var_48 = (((((c_outer_c * 256) + (i_c_outer * 128)) + cse_var_50) + c_inner_c_15) + 108);
              ((float*)DepthwiseConv2d_global_let)[cse_var_48] = (((float*)DepthwiseConv2d_global_let)[cse_var_48] + (((float*)PaddedInput_global_global_let)[(((((di * 40) + cse_var_50) + cse_var_49) + c_inner_c_15) + 132)] * ((float*)fused_constant_10_global_global_let)[((((c_outer_c * 36) + (di * 12)) + cse_var_49) + c_inner_c_15)]));
            }
          }
        }
      }
  ...
  for (int32_t ax1 = 0; ax1 < 32; ++ax1) {
    for (int32_t ax2 = 0; ax2 < 8; ++ax2) {
      for (int32_t ax3 = 0; ax3 < 8; ++ax3) {
        float __1 = ((float*)DepthwiseConv2d_global_let)[(((((ax1 >> 2) * 256) + (ax2 * 32)) + (ax3 * 4)) + (ax1 & 3))] + ((float*)fused_nn_conv2d_constant_10_let)[ax1];
        T_relu[(((ax1 * 64) + (ax2 * 8)) + ax3)] = ((__1) > (0.000000e+00f) ? (__1) : (0.000000e+00f));
      }
    }
  }
...
TVM_DLL int32_t tvmgen_cls_fused_nn_global_avg_pool2d(float* p0, float* adaptive_pool_avg, uint8_t* global_const_workspace_8_var, uint8_t* global_workspace_9_var) {
  void* adaptive_pool_sum_let = (&(global_workspace_9_var[8224]));
  for (int32_t ax0_ax1_fused = 0; ax0_ax1_fused < 8; ++ax0_ax1_fused) {
    ...
    for (int32_t rv0 = 0; rv0 < 16; ++rv0) {
      for (int32_t rv1 = 0; rv1 < 16; ++rv1) {
        ((float*)adaptive_pool_sum_let)[ax0_ax1_fused] = (((float*)adaptive_pool_sum_let)[ax0_ax1_fused] + p0[(((ax0_ax1_fused * 256) + (rv0 * 16)) + rv1)]);
      }
    }
  }
  for (int32_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < 8; ++ax0_ax1_fused_1) {
    adaptive_pool_avg[ax0_ax1_fused_1] = (((float*)adaptive_pool_sum_let)[ax0_ax1_fused_1] * 3.906250e-03f);
  }
  return 0;
}
...
TVM_DLL int32_t tvmgen_cls___tvm_main__(float* x_buffer_var, float* output_buffer_var, uint8_t* global_const_workspace_0_var, uint8_t* global_workspace_1_var) {
  ...
  void* sid_10_let = (&(global_workspace_1_var[6144]));
  void* sid_9_let = (&(global_workspace_1_var[0]));
  void* sid_11_let = (&(global_workspace_1_var[24576]));
  void* sid_58_let = (&(global_workspace_1_var[25600]));
  void* sid_8_let = (&(global_workspace_1_var[0]));
  void* sid_13_let = (&(global_workspace_1_var[16384]));
  ...
  void* sid_1_let = (&(global_workspace_1_var[82944]));
  ...
  void* sid_6_let = (&(global_workspace_1_var[8192]));
  void* sid_21_let = (&(global_workspace_1_var[21088]));
  void* sid_5_let = (&(global_workspace_1_var[8192]));
  ...
  void* sid_4_let = (&(global_workspace_1_var[8192]));
